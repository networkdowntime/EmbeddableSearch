...
public class InMemorySearchEngineTest {
	...
	public void setUp() throws Exception {
		searchEngine.add(null, 2l, "cacao");
		searchEngine.add(null, 2l, "cacao");
		searchEngine.add(null, 2l, "cacao");
		searchEngine.add(null, 2l, "cacao");
		
		searchEngine.add(null, 5l, "ban");

		searchEngine.add(null, 4l, "bad");
		searchEngine.add(null, 4l, "bad");

		searchEngine.add(null, 0l, "band");
		searchEngine.add(null, 0l, "band");
		searchEngine.add(null, 0l, "band");
		searchEngine.add(null, 0l, "band");
		searchEngine.add(null, 0l, "band");
		...
		searchEngine.add(null, 1l, "banana");
		searchEngine.add(null, 1l, "banana");
		searchEngine.add(null, 1l, "banana");
		searchEngine.add(null, 1l, "banana");
		searchEngine.add(null, 1l, "banana");

		searchEngine.add(null, 3l, "bandy");
		searchEngine.add(null, 3l, "bandy");
		searchEngine.add(null, 3l, "bandy");
	...
	public void testSearchSingleElementMatch() {
		searchEngine.add(null, 1l, "singleElement");
		Set<Long> results = searchEngine.search("singleElement", 1);
	...
	public void testSearchMultiResultMatch1() {
		searchEngine.add(null, 1l, "multiResult1");
		searchEngine.add(null, 1l, "multiResult1");
		Set<Long> results = searchEngine.search("multiResult1", 1);
		assertEquals(1, results.size());
		for (long result : results) {
			assertEquals(1, result);
		}
	...
	public void testSearchMultiResultMatchOrdering() {
		searchEngine.add(null, 1l, "multiResultMatchOrdering1");
		searchEngine.add(null, 1l, "multiResultMatchOrdering1");
		searchEngine.add(null, 2l, "multiResultMatchOrdering1");
		searchEngine.add(null, 2l, "multiResultMatchOrdering1");
		searchEngine.add(null, 2l, "multiResultMatchOrdering1");
		searchEngine.add(null, 3l, "multiResultMatchOrdering1");
		Set<Long> results = searchEngine.search("multiResultMatchOrdering1", 3);
	...
	public void testCapacity() {
		...
		for (long i=0; i < numOfElementsToTest; i++) { 
			searchEngine.add(null, i, (baseNumber + i) + "");
			if (i % tenPercent == 0) {
		...
		for (long i= 0; i < numOfElementsToTest; i++) { 
			...
			for (Long result : searchEngine.search((baseNumber + i) + "", 10)) {
