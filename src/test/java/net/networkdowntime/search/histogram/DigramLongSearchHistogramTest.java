...
//
//		FixedSizeSortedSet<SearchResult> results = digramHistogram.getSearchResults(toSet("word1 word2"), 1);
//
...
//		digramHistogram.add("word1", "word2", 1);
//
//		FixedSizeSortedSet<SearchResult> results = digramHistogram.getSearchResults(toSet("word2 word1"), 1);
//
//		assertEquals(1, results.size());
//		for (SearchResult<Long> result : results) {
//			assertEquals(1, result.getResult().longValue());
